            ...
            <div className="2xl:max-w-7xl xl:max-w-5xl pt-10">
                ...
                <div className="grid md:grid-cols-2 grid-cols-1 py-10 px-4">
                    <div className="col-span-1 p-3">
                        <h2 className="font-semibold">The Pursuit of Knowledge</h2>
                        <div className="text-sm p-4 text-muted-foreground">
                            Like Carl Sagan, let us embrace the spirit of curiosity and exploration. Our quest for knowledge should know no bounds, extending from the infinitesimal realms of quantum mechanics to the vast expanse of the cosmos. Let us cultivate a society that reveres education, critical thinking, and scientific literacy as the cornerstones of progress.
                        </div>
                    </div>
                    <div className="col-span-1 p-3">
                        <h2 className="font-semibold">The Link of Science and Spirituality</h2>
                        <div className="text-sm p-4 text-muted-foreground">
                            Recognizing the interconnectedness of all things, we must bridge the perceived chasm between science and spirituality. Like Neil deGrasse Tyson, let us seek wonder and awe in the mysteries of the universe, finding solace in the beauty of cosmic evolution and the delicate balance of life on Earth.
                        </div>
                    </div>
                    <div className="col-span-1 p-3">
                    ...
                    <div className="col-span-1 p-3">
                        ...
                        <div className="text-sm p-4 text-muted-foreground">
                            As heirs to the Enlightenment, we inherit the mantle of progress and reason. Let us reject dogma and superstition, embracing evidence-based inquiry and rational discourse as the pillars of our intellectual endeavor.
                        </div>
                    </div>
                </div>
            </div>
